...
public class FocusGroupRelativeLayout extends RelativeLayout implements FocusGroup, SimpleFocusGroup.RequestFocus {

    private FocusGroup myFocusGroup = null;

    public FocusGroupRelativeLayout(Context context) {
        super(context);
        init(null);
    }

    public FocusGroupRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public FocusGroupRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
