...
public class FocusCenterRecyclerView extends RecyclerView {
    ...
    public FocusCenterRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public FocusCenterRecyclerView(Context context, AttributeSet attrs, int defStyle) {
...
// we should scroll to make bottom visible, make sure top does not go out of bounds.
    ...
    public void refreshDownFocusView(){
        View focusView = this.getFocusedChild();
        if(focusView==null){
            return;
        }
        View v = FocusFinder.getInstance().findNextFocus(this, focusView, View.FOCUS_DOWN);
        if (v == null) {
//            int downOffset = focusView.getTop() + focusView.getHeight() / 2 - getHeight() / 2;
//            this.smoothScrollBy(0, downOffset);
//          this.smoothScrollToPosition(getLastVisiblePosition()+1);
           this.scrollToPosition(getLastVisiblePosition()+1);
        }
    }
    @Override
